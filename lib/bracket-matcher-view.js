...
class BracketMatcherView {
  constructor (editor, editorElement, matchManager) {
    ...
    this.subscriptions.add(
      ...
      atom.commands.add(editorElement, 'bracket-matcher-custom:go-to-matching-bracket', () =>
        this.goToMatchingBracket()
      ),

      atom.commands.add(editorElement, 'bracket-matcher-custom:go-to-enclosing-bracket', () =>
        this.gotoPrecedingStartBracket()
      ),

      atom.commands.add(editorElement, 'bracket-matcher-custom:select-inside-brackets', () =>
        this.selectInsideBrackets()
      ),

      atom.commands.add(editorElement, 'bracket-matcher-custom:close-tag', () =>
        this.closeTag()
      ),

      atom.commands.add(editorElement, 'bracket-matcher-custom:remove-matching-brackets', () =>
        this.removeMatchingBrackets()
      ),

      atom.commands.add(editorElement, 'bracket-matcher-custom:select-matching-brackets', () =>
  ...
  createMarker (bufferRange) {
    ...
    if (atom.config.get('bracket-matcher-custom.highlightMatchingLineNumber', {scope: this.editor.getRootScopeDescriptor()}) && this.gutter) {
